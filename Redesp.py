...
TOKEN = '6931277103:AAGmGlGvvseCqRpsZTASbcHWy6oa-i6-_Pc'
...
FORWARD_CHANNEL_ID = -1002225594499
CHANNEL_ID = -1002225594499
error_channel_id = -1002225594499
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/REDESP_MODS/13*", parse_mode='Markdown')
